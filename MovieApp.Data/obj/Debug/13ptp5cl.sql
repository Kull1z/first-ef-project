...
IF NOT EXISTS(SELECT * FROM [__EFMigrationsHistory] WHERE [MigrationId] = N'20180308092824_TomatoRating')
BEGIN
...
IF NOT EXISTS(SELECT * FROM [__EFMigrationsHistory] WHERE [MigrationId] = N'20180313104224_AddStoredProc')
BEGIN
...
BEGIN
    INSERT INTO [__EFMigrationsHistory] ([MigrationId], [ProductVersion])
    VALUES (N'20180313104224_AddStoredProc', N'2.0.1-rtm-125');
END;

GO

IF NOT EXISTS(SELECT * FROM [__EFMigrationsHistory] WHERE [MigrationId] = N'20180315100631_RenameTomtoRating')
BEGIN
    ALTER TABLE [TomatoRatings] DROP CONSTRAINT [FK_TomatoRatings_Movies_MovieId];
END;
...
IF NOT EXISTS(SELECT * FROM [__EFMigrationsHistory] WHERE [MigrationId] = N'20180315100631_RenameTomtoRating')
BEGIN
    ALTER TABLE [TomatoRatings] DROP CONSTRAINT [PK_TomatoRatings];
END;
...
IF NOT EXISTS(SELECT * FROM [__EFMigrationsHistory] WHERE [MigrationId] = N'20180315100631_RenameTomtoRating')
BEGIN
    EXEC sp_rename N'TomatoRatings', N'TomatoRating';
END;
...
IF NOT EXISTS(SELECT * FROM [__EFMigrationsHistory] WHERE [MigrationId] = N'20180315100631_RenameTomtoRating')
BEGIN
    EXEC sp_rename N'TomatoRating.IX_TomatoRatings_MovieId', N'IX_TomatoRating_MovieId', N'INDEX';
END;
...
IF NOT EXISTS(SELECT * FROM [__EFMigrationsHistory] WHERE [MigrationId] = N'20180315100631_RenameTomtoRating')
BEGIN
    ALTER TABLE [TomatoRating] ADD CONSTRAINT [PK_TomatoRating] PRIMARY KEY ([Id]);
END;
...
IF NOT EXISTS(SELECT * FROM [__EFMigrationsHistory] WHERE [MigrationId] = N'20180315100631_RenameTomtoRating')
BEGIN
    ALTER TABLE [TomatoRating] ADD CONSTRAINT [FK_TomatoRating_Movies_MovieId] FOREIGN KEY ([MovieId]) REFERENCES [Movies] ([Id]) ON DELETE CASCADE;
END;
...
BEGIN
    INSERT INTO [__EFMigrationsHistory] ([MigrationId], [ProductVersion])
    VALUES (N'20180315100631_RenameTomtoRating', N'2.0.1-rtm-125');
END;
